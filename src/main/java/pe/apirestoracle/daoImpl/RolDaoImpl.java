...
public class RolDaoImpl implements RolDao {
	...
	public int create(Rol r) {
		...
		return  jdbcTemplate.update("call PKG_ROLES.sp_create_rol(?)", r.getNombre());
	}

	@Override
	public int update(Rol r) {
		// TODO Auto-generated method stub
		return  jdbcTemplate.update("call PKG_ROLES.sp_update_roles(?,?)", r.getIdrol(),r.getNombre());
	}

	@Override
	public int delete(int id) {
		// TODO Auto-generated method stub
		return jdbcTemplate.update("call PKG_ROLES.sp_delete_roles(?)", id);
	}
	@Override
